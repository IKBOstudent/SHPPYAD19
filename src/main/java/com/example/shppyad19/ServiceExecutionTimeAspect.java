...
public class ServiceExecutionTimeAspect {
    ...
    @Pointcut("execution(* com.example.shppyad19.Departure.DepartureService.*(..)) || " +
              "execution(* com.example.shppyad19.PostOffice.PostOfficeService.*(..))")
